...
//////////////////////////////////////////////////////////////////////////
			...
			//taking the first word isn't the most robust system,
			//if this would be deployed some where i would do it otherwise.
			word = (*words_begin)[1].str(); // word now is panctuation free.
